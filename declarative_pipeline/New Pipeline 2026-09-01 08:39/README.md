# wd37_sample_py_pipeline

This folder defines all source code for the 'wd37_sample_py_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_wd37_sample_py_pipeline.py" to get familiar with the syntax.
